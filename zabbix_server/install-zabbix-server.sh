...
install_server() {
  ...
  dnf install -y zabbix-server-mysql zabbix-sender zabbix-web-mysql zabbix-apache-conf zabbix-sql-scripts zabbix-selinux-policy zabbix-agent zabbix-get openssl >>"$LOG_FILE" 2>&1
